...
class DesktopCookNowBody extends StatefulWidget {
  const DesktopCookNowBody({super.key});

  @override
  State<DesktopCookNowBody> createState() => _DesktopCookNowBodyState();
}

class _DesktopCookNowBodyState extends State<DesktopCookNowBody> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          AppLocalizations.of(context)!.cook_now,
        ),
      ),
      body: Row(
        children: [
