...
class PhoneInspirationsBody extends StatefulWidget {
  const PhoneInspirationsBody({super.key});

  @override
  State<PhoneInspirationsBody> createState() => _PhoneInspirationsBodyState();
}

class _PhoneInspirationsBodyState extends State<PhoneInspirationsBody> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: BlocConsumer<MyRecipesBloc, MyRecipesState>(
        listener: (context, state) {
          if (state.status == MyRecipesStateStatus.error) {
        ...
        builder: (context, state) {
          return state.status == MyRecipesStateStatus.error
              ? Center(
                  child: Column(
