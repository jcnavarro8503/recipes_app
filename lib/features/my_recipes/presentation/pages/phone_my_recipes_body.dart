...
class PhoneMyRecipesBody extends StatefulWidget {
  const PhoneMyRecipesBody({super.key});

  @override
  State<PhoneMyRecipesBody> createState() => _PhoneMyRecipesBodyState();
}

class _PhoneMyRecipesBodyState extends State<PhoneMyRecipesBody> {
    ...
    return SafeArea(
      child: BlocConsumer<MyRecipesBloc, MyRecipesState>(
        ...
        builder: (context, state) {
          return state.status == MyRecipesStateStatus.error && state.recipes.isEmpty
              ? Center(
                  child: Column(
