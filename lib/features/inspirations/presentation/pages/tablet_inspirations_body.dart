...
class TabletInspirationsBody extends StatefulWidget {
  const TabletInspirationsBody({super.key});

  @override
  State<TabletInspirationsBody> createState() => _TabletInspirationsBodyState();
}

class _TabletInspirationsBodyState extends State<TabletInspirationsBody> {
  @override
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                DataCardWidget(
                                  ...
                                  bottomText: AppLocalizations.of(context)!.thermomix_advanced,
                                ),
                                DataCardWidget(
