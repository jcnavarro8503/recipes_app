...
class DesktopSettingsBody extends StatefulWidget {
  const DesktopSettingsBody({super.key});

  @override
  State<DesktopSettingsBody> createState() => _DesktopSettingsBodyState();
}

class _DesktopSettingsBodyState extends State<DesktopSettingsBody> with TickerProviderStateMixin {
