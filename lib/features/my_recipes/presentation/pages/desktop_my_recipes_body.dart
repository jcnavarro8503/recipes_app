...
class DesktopMyRecipesBody extends StatefulWidget {
  const DesktopMyRecipesBody({super.key});

  @override
  State<DesktopMyRecipesBody> createState() => _DesktopMyRecipesBodyState();
}

class _DesktopMyRecipesBodyState extends State<DesktopMyRecipesBody> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: Text(AppLocalizations.of(context)!.my_recipes),
      ),
      body: Row(
        children: [
          const MyDrawer(),
